<#
    .Synopsys Script that pulls latest copy, tests it, then publishes it to the Powershell Gallery.
#>
[CmdletBinding()]
param (
    ...
    [string]$ApiKey,
    [string]$ProjectUri = 'https://github.com/treestryder/powershell_module_oledbsql.git',
...
$rootPath   = './powershell_module_oledbsql'
$sourcePath = $rootPath + '/source'
$modulePath = $rootPath + '/OledbSql'
try {
